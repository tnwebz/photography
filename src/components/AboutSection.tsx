...
const PHOTOS = [
  {
    ...
    alt: 'Wedding lights',
    className:
      'absolute right-0 top-0 z-10 h-[130px] w-[58%] max-w-[200px] sm:h-[200px] sm:max-w-[300px] sm:w-[300px] md:h-[240px] md:max-w-[360px] md:w-[360px]',
    delay: 0.1,
  },
  {
    src: '/p2.png',
...
export function AboutSection() {
  return (
    <section id="about" className="bg-white px-4 py-16 sm:px-8 sm:py-20 lg:px-14 lg:py-28">
      <div className="mx-auto grid max-w-7xl items-center gap-10 sm:gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="order-2 lg:order-1">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-zinc-400">About Us</p>
          <h2 className="mt-3 font-serif text-3xl text-black sm:mt-4 sm:text-4xl lg:text-5xl">Our Story</h2>
          ...
          <p className="mt-5 max-w-lg text-sm leading-relaxed text-zinc-500 sm:mt-6">
            For over fifteen years we have been candid wedding photographers — finding beauty in honest
            moments, unposed laughter, and the quiet in-betweens that become your family&apos;s legacy.
          </p>
        </div>
